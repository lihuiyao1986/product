...
/**
 *@Description:编辑用户的爱好请求参数
 *@Author:李焱生
 *@Since:2015年5月7日下午10:43:18  
 */
public class UserHobbyEditReqModel extends BaseReqModel {

    private static final long serialVersionUID = 747469357904630861L;
